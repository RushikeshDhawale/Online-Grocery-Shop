								...
								<div class="p-5">
									...
									<form action="usersignup" method="post">
										...
										<div class="form-group mb-5">
											...
											<input name="mobile" type="text" pattern="[0-9]{10}"
												class="form-control" id="exampleInputPassword1"
												required="required">
										</div>

										<div class="form-group mb-5">
											<label for="exampleInputPassword1">Password (6-16
												characters)</label> <input name="password" minlength="6"
							...
							<div class="col-lg-6 d-none d-lg-inline-block">
								<div class="account-block rounded-right">
									...
									<div class="account-testimonial">
										...
										<p class="lead text-white">"We believe in delivering not
											just groceries but smiles to your doorstep."</p>
										<p>-Coder&Rider</p>
									</div>
								</div>
							</div>
