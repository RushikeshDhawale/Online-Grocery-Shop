...
<link rel="icon" href="imag/logo.png" type="image/x-icon">
	...
	<section class="featured spad">
		<div class="container">
			...
			<div class="row featured__filter">
				...
				List<AddProductsPage> list = bean.readFeaturedProducts();
				...
				<div class="col-lg-3 col-md-4 col-sm-6 mix fastfood vegetables">
					<div class="featured__item"
						...
						<div class="featured__item__text">
							...
							<h5>
								<del>Rs.<%=li.getCrossprice()%>/-</del>
							</h5>
							<h5>Rs.<%=li.getMainprice()%>/-only</h5>

							<a href="https://example.com/buy-now" class="btn btn-primary">Buy
								Now</a>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="blog__item">
						...
						<div class="blog__item__text">
							<ul>
								<li><i class="fa fa-calendar-o"></i> <%=LocalDate.now().toString() %></li>
