...
<%@page import="com.mughalsaraibazaar.main.dao.UserSignupDao"%>
						...
						<div class="row no-gutters">
							<div class="col-lg-6">
								<div class="p-5">
								   ...
								   <%
								   ArrayList<String> al =(ArrayList<String>)session.getAttribute("userdata");
								   if(al==null){
								   %>
									...
									<a href="usersignup.jsp" >SIGNUP HERE</a><br>
